...
class Menu_E_P4 extends BaseController
{
    public function index()
    {
        ...
        $data = [
            'menuuri' => $myuri[0],
            'title' => 'Aplikasi Power Tidak Bisa Login',
            'update' => '16:26 30/Oct/20',
            'rootcause' => [
                'Case Aplikasi Power (General)'
            ],
            'cwc' => ['Complaint - Lubricant - Aplikasi Power Tidak Bisa Login'],
            'todolist' => [
                'Case Aplikasi Power (General)'
            ],
            'mandatory' => [
