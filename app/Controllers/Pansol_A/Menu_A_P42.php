...
class Menu_A_P42 extends BaseController
{
    public function index()
    {
        ...
        $data = [
            'menuuri' => $myuri[0],
            'title' => 'Pembatasan Pembelian BBM (Non subsidi)',
            'update' => '16:44 21/Oct/20',
            'rootcause' => [
                'Pelanggan mengeluhkan adanya pembatasan untuk pembelian BBM (Non Subsidi).' => [
                    '-'
                ],
            ...
            'cwc' => ['Complaint - Layanan BBK - Pembatasan Pembelian BBM (Non subsidi)'],
            'fcr' => [
                'Jika sudah ada SK Aturan pembatasan di edukasi kepada pelanggan',
