...
class Menu_A_P59 extends BaseController
{
    public function index()
    {
        ...
        $data = [
            'menuuri' => $myuri[0],
            'title' => 'Promo di SPBU COCO',
            'update' => '10:59 26/Oct/20',
            'rootcause' => [
                'Pelanggan menanyakan promo yang sedang berlaku di SPBU'
            ],
            'cwc' => ['Information - Layanan BBK - Promo di SPBU COCO'],
            'todolist' => [
