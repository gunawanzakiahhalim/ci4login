...
class Menu_A_P56 extends BaseController
{
    public function index()
    {
        ...
        $data = [
            'menuuri' => $myuri[0],
            'title' => 'Petugas Tidak Teliti',
            'update' => '13:32 23/Oct/20',
            'rootcause' => [
                'Permasalahan terkait dengan sikap dan proses layanan petugas SPBU yang tidak sesuai dengan SOP.',
                'Pelanggan mengeluhkan bahwa Petugas tidak teliti.'
            ],
            'cwc' => ['Complaint - Layanan BBK - Petugas tidak teliti'],
            'todolist' => [
                'Nama Pelapor',
