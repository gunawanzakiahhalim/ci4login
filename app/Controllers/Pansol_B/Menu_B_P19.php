...
class Menu_B_P19 extends BaseController
{
    public function index()
    {
        ...
        $data = [
            'menuuri' => $myuri[0],
            'title' => 'Keluhan Harga LPG, Bright Gas, EASE Gas',
            'update' => '10:36 27/Oct/20',
            'rootcause' => [
                'Terkait Keluhan Harga LPG, Bright Gas, EASE Gas'
            ],
            'cwc' => ['Complaint - Layanan Domgas - Keluhan Harga LPG, Bright Gas, EASE Gas'],
            'todolist' => [
