    ...
    <div class="tab-pane fade show active" id="nav-rootcause" role="tabpanel" aria-labelledby="nav-rootcause-tab">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p><img src="<?= base_url(); ?>/assets/img/spbu/<?= $gambar; ?>" class="img-fluid" alt="invalidparameter"></p>
        </div>
    ...
    <div class="tab-pane fade" id="nav-todolist" role="tabpanel" aria-labelledby="nav-todolist-tab">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p><img src="<?= base_url(); ?>/assets/img/spbu/<?= $edc; ?>" class="img-fluid" alt="paymentpertamax"></p>
        </div>
      </div>
    </div>
