    ...
    <div class="tab-pane fade show active" id="nav-rootcause" role="tabpanel" aria-labelledby="nav-rootcause-tab">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <h6>Contoh Case :</h6>
          <ol>
            <?php for ($i = 0; $i < count($contoh); $i++) : ?>
              <li><?php echo $contoh[$i]; ?></li>
            <?php endfor; ?>
          </ol>
          <hr>
          <ol>
            <?php for ($i = 0; $i < count($transportasi); $i++) : ?>
              <li><?php echo $transportasi[$i]; ?></li>
            <?php endfor; ?>
          </ol>
          <ul>
            <?php for ($i = 0; $i < count($kecurangan); $i++) : ?>
              <li><?php echo $kecurangan[$i]; ?></li>
            <?php endfor; ?>
          </ul>
        </div>
